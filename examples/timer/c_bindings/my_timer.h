...
typedef struct MyTimerBytesEchoReq {
    BytesPayload blob;
} MyTimerBytesEchoReq;
...
typedef struct MyTimerBytesEchoResp {
    BytesPayload value;
} MyTimerBytesEchoResp;
...
int my_timer_bytes_echo_v22ae011(void* ctx, FfiCallback cb, void* user_data, const MyTimerBytesEchoReq* req);
#define my_timer_bytes_echo my_timer_bytes_echo_v22ae011
